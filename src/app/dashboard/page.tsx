...
import { Compass, ChevronRight, Sparkles, Brain, Target, ShieldCheck, BookOpen, FileText, Users, MessageSquare } from 'lucide-react';
import { USER, SUBJECT_MODULES, CHECKIN_MILESTONES, MOOD_OPTIONS, AI_ENCOURAGEMENTS, ENERGY_QUOTES, JOURNEY_PHASES, PROVINCE_DATA } from '@/lib/data';
import { cn } from '@/lib/utils';

const ICON_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
  Compass, Brain, Target, ShieldCheck, BookOpen, FileText, Users, MessageSquare,
};
...
function AnimatedNumber({ value }: { value: number }) {
  ...
  return <span className="text-3xl font-mono text-white tabular-nums">{display.toLocaleString()}</span>;
}
